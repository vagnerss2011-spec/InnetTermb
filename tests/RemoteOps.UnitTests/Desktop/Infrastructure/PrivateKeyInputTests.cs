...
{
    [Theory]
    [InlineData("-----BEGIN OPENSSH PRIVATE KEY-----\nabc\n-----END OPENSSH PRIVATE KEY-----", PrivateKeyKind.Valid)] // pragma: allowlist secret (fixture sintético)
    [InlineData("-----BEGIN RSA PRIVATE KEY-----\nabc\n-----END RSA PRIVATE KEY-----", PrivateKeyKind.Valid)] // pragma: allowlist secret (fixture sintético)
